...
of <if id="forceMajeure" value="something something" whenTrue="%20except%20for%20Force%20Majeure%20cases%2C" whenFalse="something something"/> delay penalty amounting to <variable id="penaltyPercentage" value="10.5"/>% of the total value of the Equipment
...
exceed <variable id="capPercentage" value="55.0"/>% of the total value of the Equipment involved in late delivery. <if id="forceMajeure" value="something something" whenTrue="%20except%20for%20Force%20Majeure%20cases%2C" whenFalse="something something"/>
